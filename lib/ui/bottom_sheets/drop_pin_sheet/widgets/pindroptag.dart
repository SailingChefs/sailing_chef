...
class TagsSelectionWidget extends ViewModelWidget<DropPinSheetSheetModel> {
  ...
  Widget build(BuildContext context, DropPinSheetSheetModel viewModel) {
    return SizedBox(
      ...
      height: viewModel.isTagsVisible == true ? MediaQuery.of(context).size.height*0.53 : MediaQuery.of(context).size.height*0.08,
      child: Column(
        children: [
          GestureDetector(
            onTap: () {
          ...
          const Divider(),
          Container(
            height: viewModel.isTagsVisible == true ? MediaQuery.of(context).size.width*0.94 : 0,
            width: viewModel.isTagsVisible == true ? MediaQuery.of(context).size.width*0.95 : 0,
