...
class EditIngredientTextField extends ViewModelWidget<EditIngredientSheetModel> {
  EditIngredientTextField({super.key, this.hintText, this.prefix, this.postfix, this.width});
