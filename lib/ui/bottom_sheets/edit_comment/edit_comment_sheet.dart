...
class EditCommentSheet extends StackedView<EditCommentSheetModel> {
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: List.generate(viewModel.existingImages.length, (index) {
                            bool isMarkedForDeletion = viewModel.isExistingImageMarkedForDeletion(index);
                            ...
                            return Stack(
                              ...
                              children: [
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      ...
                                      colorFilter: isMarkedForDeletion 
                                        ? ColorFilter.mode(Colors.red.withOpacity(0.3), BlendMode.srcOver) 
                                        : null,
                                    ),
                                ...
                                IconButton(
                                  icon: Icon(
                                    isMarkedForDeletion ? Icons.refresh : Icons.cancel, 
  ...
  EditCommentSheetModel viewModelBuilder(BuildContext context) => 
    EditCommentSheetModel(
      ...
      completer: completer,
      rating: request.data['rating'] ?? 0.0,
    );
}
