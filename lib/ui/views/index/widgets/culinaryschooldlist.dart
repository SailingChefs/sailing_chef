            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  itemCount: viewModel.cullinary.length > 20 ? 5 : viewModel.cullinary.length,
                        ...
                        child: Column(
                          children: [
                            ClipRRect(
                              ...
                              child: cullinaruschools.displayPicture == ''
                                  ? Image.asset(
                                      ...
                                      fit: BoxFit.cover,
                                      height: MediaQuery.sizeOf(context).height * 0.25.h - 48.h,
                                    )
                                  : CachedNetworkImage(
                            ...
                            Padding(
                              ...
                              child: Text(
                                capitalizeEachWord(cullinaruschools.displayName!),
                                style: TextStyle(
                                  fontSize: 14.sp,
