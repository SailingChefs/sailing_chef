...
Future<void> downloadAudio() async {
  ...
  void addIngredients(List<Ingredient> newIngredients) async {
    ...
    if (result == null) return;
    ingredientsList = [...newIngredients, ...result.data.ingredientsList];
    notifyListeners();
  }
  ...
  void addMethods(List<String> newMethods) async {
    ...
    methodsList = [...newMethods, ...method.data.instructionsListResponse];
    notifyListeners();
    rebuildUi();
  }
  ...
  void callIngredientsBottomSheet() async {
    ...
    if (result == null) return;
    ingredientsList = [...ingredientsList, ...result.data.ingredientsList];
    rebuildUi();
    notifyListeners();
  }
  ...
  void callCookingInstructionBottomSheet() async {
    ...
    if (method == null) return;
    methodsList = [...methodsList, ...method.data.instructionsListResponse];
