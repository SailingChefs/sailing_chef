...
class ShoppingListView extends StackedView<ShoppingListViewModel> {
  ...
  Widget builder(
    ...
    log(viewModel.shoppingListService.selectedRecipees.toString());
          ...
          : Stack(
              children: [
                SingleChildScrollView(
                  ...
                  child: viewModel.shoppingListService.selectedRecipees.isEmpty
                      ? Container(
                      ...
                      : SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              for (var recipee in viewModel
                                  .shoppingListService.selectedRecipees)
                                Column(
                                    ...
                                    children: [
                                      ...
                                      for (var selectIngredient in viewModel
                                                      .shoppingListService
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            final selectedRecipe = viewModel
                                                .shoppingListService
                                                .selectedRecipees
                                                .indexWhere((element) =>
                                                    element.docId ==
                                      ...
                                      for (var unSelectIngredient in viewModel
                                                      .shoppingListService
                                                      .showShoppingListview[
                                                  recipee.title]
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Visibility(
                      visible: viewModel
                              .shoppingListService.selectedRecipees.isNotEmpty
                          ? true
                          : false,
                      child: Center(
                        child: Container(
