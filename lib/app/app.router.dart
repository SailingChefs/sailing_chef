...
import 'package:sailing_chefs/core/imports/core_imports.dart' as _i30;
import 'package:sailing_chefs/model/recipe_model.dart' as _i32;
import 'package:sailing_chefs/model/user_model.dart' as _i29;
...
class AddRecipeViewArguments {
  ...
  final List<_i31.Ingredient>? ingredientsList;
...
class RecipeViewViewArguments {
  ...
  final _i32.RecipeModel recipeModel;

  final List<_i33.XFile>? selectedImages;
...
class AllChefsViewArguments {
  ...
  final List<_i29.UserModel> chefList;
...
extension NavigatorStateExtension on _i34.NavigationService {
  ...
  Future<dynamic> navigateToChatView({
    required _i29.UserModel receiver,
  ...
  Future<dynamic> navigateToAddRecipeView({
    required List<_i31.Ingredient>? ingredientsList,
    _i30.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
  ...
  Future<dynamic> navigateToRecipeViewView({
    required _i32.RecipeModel recipeModel,
    required List<_i33.XFile>? selectedImages,
    _i30.Key? key,
  ...
  Future<dynamic> navigateToAllChefsView({
    _i30.Key? key,
    required List<_i29.UserModel> chefList,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
