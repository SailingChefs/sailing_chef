...
import 'package:sailing_chefs/core/imports/core_imports.dart' as _i37;
import 'package:sailing_chefs/model/recipe_model.dart' as _i38;
import 'package:sailing_chefs/model/user_model.dart' as _i39;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i35.ShoppingListView: (data) {
      return _i36.MaterialPageRoute<dynamic>(
        builder: (context) => const _i35.ShoppingListView(),
        settings: data,
      );
    },
  };
...
class RecipeViewViewArguments {
  ...
  final _i38.RecipeModel recipeModel;

  final List<_i40.XFile> selectedImages;
...
class SavedRecipeDetailsViewArguments {
  ...
  final List<_i38.RecipeModel> randomRecipeList;
...
class AllChefsViewArguments {
  ...
  final List<_i39.UserModel> chefList;
...
class ExploreAllRecipesViewArguments {
  ...
  final List<_i38.RecipeModel> recipes;
...
class SearchViewArguments {
  ...
  final List<_i38.RecipeModel> recipeModel;
...
extension NavigatorStateExtension on _i41.NavigationService {
  ...
  Future<dynamic> navigateToRecipeViewView({
    required _i38.RecipeModel recipeModel,
    required List<_i40.XFile> selectedImages,
  ...
  Future<dynamic> navigateToSavedRecipeDetailsView({
    _i37.Key? key,
    required _i38.RecipeModel recipeModel,
    required List<_i38.RecipeModel> randomRecipeList,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToAllChefsView({
    _i37.Key? key,
    required List<_i39.UserModel> chefList,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToChatView({
    required _i39.UserModel receiver,
  ...
  Future<dynamic> navigateToExploreAllRecipesView({
    _i37.Key? key,
    required List<_i38.RecipeModel> recipes,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToSearchView({
    _i37.Key? key,
    required List<_i38.RecipeModel> recipeModel,
    required List<_i39.UserModel> chefList,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
